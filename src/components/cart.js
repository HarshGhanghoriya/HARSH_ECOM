            ...
            <div className="flex md:justify-between md:flex-row flex-col pt-4">
                ...
                <div className="flex flex-col md:p-4">
                  ...
                  <div className="offers flex border border-gray-300 rounded-3xl px-2 py-4 my-4 text-sm font-medium md:text-md">
                    <svg
                      ...
                      stroke-width="0"
                      viewBox="0 0 24 24"
                      className="mt-1 text-primary mr-2 text-lg"
                      height="1em"
                      width="1em"
                        ...
                        <div className="flex flex-col">
                          <div className="item flex flex-row">
                            ...
                            <div className="details">
                              ...
                              <div className="price mt-1 flex">
                                <div className="discounted">{`₹${item.price}`}</div>
                          ...
                          <div className="buttons flex justify-end">
                            <div className="flex items-center justify-center">
                              <button className="border border-gray-300 rounded-full p-1  md:p-2 hover:border-primary">
                                <svg
                                  stroke="currentColor"
                                  fill="currentColor"
                                  stroke-width="0"
              ...
              <div className="cart-details md:w-1/3 flex flex-col md:ml-5">
                <div className="cupon md:border md:border-gray-300 md:rounded-3xl p-4">
                  ...
                  <div className="cupon mt-4 flex">
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-6 absolute mt-2 text-primary"
                    >
                      <path
                    ...
                    <input
                      type="text"
                      className="border-b-2 border-black outline-none text-black hover:border-primary focus:border-primary pl-8 w-full"
                      placeholder="Enter Cupon Code"
                      fdprocessedid="jz02qk"
                    />
                    <button
                      className="bg-transparent hover:border-primary text-primary font-semibold py-2 px-3 border border-gray-300 rounded-full transition"
                      fdprocessedid="zekpm"
                    >
                      Check
                    </button>
                  ...
                  <div className="p-4 mt-4 md:rounded-3xl md:border md:border-gray-300">
                    ...
                    <div className="break flex flex-col">
                      <div className="mrp-total flex justify-between pt-2 md:text-lg">
                        ...
                        <div className="value text-gray-500">
                          {totalCartValue}
                        </div>
                      </div>
                      <hr />
                ...
                <Button
                  title={"Place Order"}
                  classes={
                    "placeorder bg-primary mt-4 text-white px-4 py-2 font-semibold md:text-lg rounded-3xl"
                  }
