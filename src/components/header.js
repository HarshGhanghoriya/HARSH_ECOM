...
export default function Header() {
  return (
    <div className=" sticky top-0 z-10">
      <header className="text-gray-600 body-font  shadow-xl w-full bg-opacity-50 backdrop-filter backdrop-blur-lg bg-[#ffffff2d]">
        <div className="container mx-auto flex flex-wrap p-5 flex-row items-center justify-between md:justify-center">
          ...
          <nav className="md:ml-auto md:flex  md:mr-auto  flex-wrap items-center text-base justify-center mb-3 md:mb-0 ">
            <Link
              className="mr-5 hover:text-emerald-900 font-bold"
              href="/"
            >
              Tshirts
            </Link>
          ...
          <div className="flex items-center">
            ...
            <Link className="flex items-center ml-4" href="/cart">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
              ...
              <div className="flex absolute -mt-6 ml-5">
        ...
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center md:hidden">
          ...
          <Link className="mr-5 hover:text-emerald-900 font-bold" href="/pants">
            Pants
          </Link>
        </nav>
      </header>
